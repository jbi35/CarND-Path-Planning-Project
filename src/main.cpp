...
// spline interpolation examples from
...
void generate_dummy_path(vector<double> &new_path_x,
                         ...
                         double car_yaw)
{
  ...
  new_path_x = next_x_vals;
  new_path_y = next_y_vals;
...
int main()
{
  ...
  // target velocity
  double target_vel = 0; // given in mph

  h.onMessage([&target_vel,&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                     uWS::OpCode opCode) {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            {
              //cout << "increasing velocity starting from target_vel " <<  target_vel << endl;
              target_vel += 0.224;
            }
            ...
            // genearate_dummy_path(next_x_vals, next_y_vals,
            //                    previous_path_x,
            //                    previous_path_y, car_x, car_y, car_yaw);
            // simple stay in lane command 16:28 min in video
            ...
            //cout << "next_x_vals 1" << next_x_vals[1] << endl;
            //cout << "next_y_vals 0 " << next_y_vals[0] << endl;
